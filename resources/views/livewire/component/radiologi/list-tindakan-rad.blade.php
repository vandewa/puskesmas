    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <table class="table table-striped @error('pilihan') text-danger @enderror">
                <thead>
                    <th class=" " colspan="2">Nama Pemeriksaan  @error('pilihan')  <span class="form-text text-danger">{{ $message }}</span> @enderror</th>
                </thead>
                <tbody>
        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-10"><input type="datetime-local" class="form-control" wire:model.live='form.datetime_trx'></div>
