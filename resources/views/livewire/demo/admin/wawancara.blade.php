                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label">Wawancara berhasil dan bisa dilakukan proses selanjutnya</label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input" value="0" type="radio" name="radio1"  wire:model.live="persetujuan">
                                        <label class="form-check-label">Wawancara gagal proses dihentikan</label>
                                      </div>
                                </div>
                              </div>
                              @if($persetujuan)
