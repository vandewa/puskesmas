                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="" wire:model.live='medicalRecord.medical_note' id="" class="form-control"
                                                rows="2"></textarea>
                                        </div>
                                    </div>
                                                ...
                                                <div class="" style="overflow:hidden;">
                                                    ...
                                                    <div class="row" style="margin-top:5px;">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            {{ $pasien->provinsi->region_nm }}
                                                            {{ $pasien->kabupaten->region_nm ?? '' }}
                                                            {{ $pasien->kecamatan->region_nm ?? '' }}
                                                            {{ $pasien->kelurahan->region_nm ?? '' }}
                                                            {{ $pasien->address }}
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <tbody>
                                    @foreach ($posts as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" wire:click='pilih("{{ $item->seq_no }}")'
