                ...
                <div class="col-md-12">
                    <div class="card card-success card-outline">
                        <form class="form-horizontal mt-2" wire:submit='save'>
                            @if ($edit)
                                <input type="hidden" value="{{ $form['supplier_cd'] }}" wire:model="form.supplier_cd">
                            @endif
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Kode Supplier</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" wire:model='form.supplier_cd'
                                                    @if ($edit) disabled @endif>
                                                @error('form.supplier_cd')
                                                    <span class="form-text text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Nama Supplier</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control"
                                                    wire:model='form.supplier_nm'>
                                                @error('form.supplier_nm')
                                                    <span class="form-text text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            <label for="" class="col-sm-3 col-form-label">Kontak
                                                Person</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" wire:model='form.pic'>
                                                @error('form.pic')
                                                    <span class="form-text text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
