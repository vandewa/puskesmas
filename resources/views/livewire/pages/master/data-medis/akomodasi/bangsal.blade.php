                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" wire:model='form.bangsal_cd'
                                                    placeholder="Kode Bangsal"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" wire:model='form.bangsal_nm'
                                                    placeholder="Nama Bangsal">
                                                @error('form.bangsal_nm')
                                                    <span class="form-text text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
                                        ...
                                        <tr wire:key='{{ $item->bangsal_cd }}'>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-danger btn-flat btn-sm"
                                                    ...
                                                    wire:click="setDelete('{{ $item->bangsal_cd }}')"><i
