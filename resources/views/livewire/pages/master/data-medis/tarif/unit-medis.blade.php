<div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Tarif Unit Medis</li>
                </ol>
            </div>
        </div>
    </x-slot>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-2 row">
                                            <label for="" class="col-sm-3 col-form-label">Unit Medis</label>
                                            <div class="col-md-9">
                                                <div class="input-group ">
                                                    <p class="form-control">{{ $medicalunit->medicalunit_nm ?? '' }}</p>
                                                    <span class="input-group-append">
                                                        <button type="button" class="btn btn-info btn-flat"
                                                            wire:click="$dispatch('show-modal-unit-medis')">Cari</button>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <tbody>
                                    @foreach ($post as $item)
                                        <tr wire:key='{{ $item->seq_no }}'>
                                            <td>{{ $item->unitMedisItem->medicalunit_nm ?? '-' }}</td>
    ...
    <livewire:component.modal-account wire:key='modal-account'>
        <livewire:component.modal-unit-medis wire:key='modal-unit-medis'>
</div>
