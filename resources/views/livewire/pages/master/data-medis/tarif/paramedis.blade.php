        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Tarif Paramedis</li>
                </ol>
            </div>
        </div>
    </x-slot>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-2 row">
                                            <label for="inputEmail3" class="col-sm-3 col-form-label">Paramedis</label>
                                            <div class="col-sm-9">
                                                <select class="form-control" wire:model='form.paramedis_tp'>
                                                    <option value="">Pilih Paramedis</option>
                                                    @foreach ($listParamedis ?? [] as $item)
                                                        <option value="{{ $item['com_cd'] }}">
                                                            {{ $item['code_nm'] }}</option>
                                                    @endforeach
                                                </select>
                                                @error('form.paramedis_tp')
                                                    <span class="form-text text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        </div>
