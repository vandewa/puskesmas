                                                        ...
                                                        <ul class="nav nav-tabs" id="custom-tabs-two-transaksi-tab"
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link active"
                                                                    ...
                                                                    data-toggle="pill"
                                                                    href="#custom-tabs-two-riwayat-kunjungan"
                                                                    role="tab"
                                                ...
                                                <div class="card card-dark card-tabs">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="tab-content" id="custom-tabs-three-tabContent">
                                                            ...
                                                            <div class="tab-pane fade"
                                                                id="custom-tabs-three-tindakan-diproses"
                                                                role="tabpanel"
                                                                aria-labelledby="custom-tabs-three-tindakan-diproses-tab">
                                                                TINDAKAN DIPROSES
                                                            </div>
                                                            <div class="tab-pane fade"
                                                                id="custom-tabs-three-riwayat-tindakan"
                                                                role="tabpanel"
                                                ...
                                                <div class="card card-dark card-tabs">
                                                        ...
                                                        <ul class="nav nav-tabs" id="custom-tabs-four-transaksi-tab"
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link active"
                                                                    ...
                                                                    data-toggle="pill"
                                                                    href="#custom-tabs-four-permintaan-lab"
                                                                    role="tab"
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link"
                                                                    id="custom-tabs-four-proses-lab-tab"
                                                                    data-toggle="pill"
                                                                    href="#custom-tabs-four-proses-lab" role="tab"
                                                                    aria-controls="custom-tabs-four-proses-lab"
                                                                    aria-selected="false">Proses Lab</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link"
                                                                    id="custom-tabs-four-riwayat-lab-tab"
                                                                    data-toggle="pill"
                                                                    href="#custom-tabs-four-riwayat-lab"
                                                                    role="tab"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="tab-content" id="custom-tabs-four-tabContent">
                                                            ...
                                                            <div class="tab-pane fade"
                                                                id="custom-tabs-four-proses-lab" role="tabpanel"
                                                                aria-labelledby="custom-tabs-four-proses-lab-tab">
                                                                PROSES LAB
                                                            </div>
                                                            <div class="tab-pane fade"
                                                                id="custom-tabs-four-riwayat-lab" role="tabpanel"
                                                ...
                                                <div class="card card-dark card-tabs">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="tab-content" id="custom-tabs-five-tabContent">
                                                            <div class="tab-pane fade show active"
                                                                id="custom-tabs-five-permintaan-radiologi"
                                                                role="tabpanel"
                                                            ...
                                                            <div class="tab-pane fade"
                                                                id="custom-tabs-five-riwayat-radiologi"
                                                                role="tabpanel"
                                                ...
                                                <div class="card card-dark card-tabs">
                                                        ...
                                                        <ul class="nav nav-tabs" id="custom-tabs-six-transaksi-tab"
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link"
                                                                    ...
                                                                    data-toggle="pill"
                                                                    href="#custom-tabs-six-template-resep"
                                                                    role="tab"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="tab-content" id="custom-tabs-six-tabContent">
                                                            ...
                                                            <div class="tab-pane fade"
                                                                id="custom-tabs-six-template-resep" role="tabpanel"
