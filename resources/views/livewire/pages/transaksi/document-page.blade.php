<div>
    <x-slot name="header">
        <div class="mb-2 row">
            <div class="col-sm-6">
                <h1 class="m-0">Dokumen Pasien</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Transaksi</a></li>
                    <li class="breadcrumb-item active">Dokumen Pasien</li>
                </ol>
            </div>
        </div>
    </x-slot>
                                                        ...
                                                        <ul class="nav nav-tabs" id="custom-tabs-six-transaksi-tab"
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link"
                                                                    ...
                                                                    aria-selected="false">Riwayat Dokumen</a>
                                                            </li>
                                                            ...
                                                            <li class="nav-item"
                                                                ...
                                                                <a class="nav-link" data-toggle="pill"
                                                                    ...
                                                                    href="#custom-tabs-six-template-resep"><i
                                                                        ...
                                                                        style="color:black">Tambah Dokumen</span></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="tab-content" id="custom-tabs-six-tabContent">
                                                            <div class="tab-pane fade show active"
                                                                ...
                                                                <livewire:component.document.table-document :medicalcd="$medik->medical_cd">
                                                            </div>
                                                            <div class="tab-pane fade"
                                                                id="custom-tabs-six-riwayat-resep" role="tabpanel"
                                                                aria-labelledby="custom-tabs-six-riwayat-resep-tab">
                                                                <livewire:component.document.table-riwayat-document
                                                            ...
                                                            <div class="tab-pane fade" id="tambah-resep" role="tabpanel"
                                                                ...
                                                                <livewire:component.document.form-document :pasiencd="$medik->pasien_cd" :dr='$medik->dr_cd' :medicalcd="$medik->medical_cd">
