                        ...
                        <form class="form-horizontal mt-2" wire:submit="save">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row margin-bawah">
                                            <label for="inputEmail3" class="col-sm-3 col-form-label empatbelas">No.
                                                RM</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" wire:model="form.no_rm"
                                                    readonly>
                                                @error('form.no_rm')
                                        ...
                                        <div class="form-group row margin-bawah">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="" id="" class="form-control"
                                                    wire:model.live='form.region_prop'>
                                                    <option value="">Pilih Provinsi</option>
                                                    @foreach ($prop as $item)
                                                        <option value="{{ $item['region_cd'] }}">
                                                            {{ $item['region_nm'] }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row margin-bawah">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="" id="" class="form-control"
                                                    wire:model.live='form.region_kab'>
                                        ...
                                        <div class="form-group row margin-bawah">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="" id="" class="form-control"
                                                    wire:model.live='form.region_kec'>
                                        ...
                                        <div class="form-group row margin-bawah">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="" id="" class="form-control"
                                                    wire:model.live='form.region_kel'>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row margin-bawah">
                                            <label for="inputEmail3" class="col-sm-3 col-form-label empatbelas">Tipe
                                                Pasien</label>
                                            <div class="col-sm-9">
                                                <select name="" wire:model.live='form.pasien_tp'
                                        ...
                                        {{-- <div class="form-group row margin-bawah">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="" id="" class="form-control"
                                                    wire:model.live='insurance.insurance_tp'
                                                    @if ($form['pasien_tp'] != 'PASIEN_TP_02') disabled @endif>
                                        ...
                                        <div class="form-group row margin-bawah">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"
                                                    wire:model.live="insurance.insurance_no"
                                                    @if ($form['pasien_tp'] != 'PASIEN_TP_02') disabled @endif>
                                        ...
                                        <div class="form-group row margin-bawah">
                                            <label for="inputPassword3"
                                                class="col-sm-3 col-form-label empatbelas">Status Pernikahan</label>
                                            <div class="col-sm-9">

                                                <select name="" id="" class="form-control"
                                                    wire:model="form.marital_tp">
                                        ...
                                        <div class="form-group row margin-bawah">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="" id="" class="form-control"
                                                    wire:model="form.nation_cd">
                                                    <option value="">Pilih Negara</option>
                                                    @foreach ($negara ?? [] as $item)
                                                        <option value="{{ $item['nation_cd'] }}">
                                                            {{ $item['nation_nm'] }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group row margin-bawah">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" wire:model="form.pj_name">
                                                @error('form.pj_name')
                                                    <span class="form-text text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row margin-bawah">
                                            <label for="inputPassword3"
                                                class="col-sm-3 col-form-label empatbelas">Telepon</label>
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control" wire:model="form.pj_telp">
                                                @error('form.pj_telp')
                                                    <span class="form-text text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('pasien.index') }}" wire:navigate
                                    class="btn btn-default float-right">Batalkan</a>
                            </div>
                            <!-- /.card-footer -->
                        </form>
                        <!-- /.card-header -->
