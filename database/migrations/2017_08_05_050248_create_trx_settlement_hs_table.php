...
class CreateTrxSettlementHsTable extends Migration {
	...
	public function up()
	{
		Schema::create('trx_settlement_hs', function(Blueprint $table)
		{
			$table->bigInteger('settlement_no')->primary('trx_settlement_hs_pkey');
