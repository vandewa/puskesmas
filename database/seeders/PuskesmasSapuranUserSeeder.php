...
class PuskesmasSapuranUserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['name' => 'Dwi Indaryati', 'email' => 'Dwi@app.com', 'password' => bcrypt('password'), 'role' => 'bidan'],
            ...
            ['name' => 'Retno W. B', 'email' => 'Retnowa@app.com', 'password' => bcrypt('password'), 'role' => 'bidan'],
            ...
            ['name' => 'Dwi Karuniawan', 'email' => 'Dwi@app.com', 'password' => bcrypt('password'), 'role' => 'perawat'],
