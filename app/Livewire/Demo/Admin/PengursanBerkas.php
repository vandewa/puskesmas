...
use App\Models\Mcu;
use App\Models\PengurusanBerkas as UrusBerkas;
use App\Models\Wawancara1;
use App\Models\Wawancarauser;

class PengursanBerkas extends Component
{
    use WithPagination;
    public $cari;
    ...
    public function proses($id) {
        ...
        $this->berkas = UrusBerkas::where('lamaran_id', $id)->get();
    ...
    {
        $data = Lamaran::with(['tahapan', 'user'])->where('tahapan_id',7)
        ->where('status', 'Dalam Proses')
        ->paginate(10);
        return view('livewire.demo.admin.pengursan-berkas', [
            'posts' => $data
        ]);
    }
}
