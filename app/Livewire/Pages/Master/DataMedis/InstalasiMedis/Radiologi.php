...
class Radiologi extends Component
{
    ...
    {
        return TrxUnitmedisItem::where('root_st', 1)->where('cbg_tarif_tp', 'CBG_TARIF_07')->get()->toArray();
    }
    ...
    {
        $data = TrxUnitmedisItem::cari($this->cari)->where('medunit_cd', 'RADIO00')->paginate(10);
        return view('livewire.pages.master.data-medis.instalasi-medis.radiologi', [
            'post' => $data,
